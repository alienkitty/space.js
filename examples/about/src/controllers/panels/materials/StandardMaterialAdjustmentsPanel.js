...
export class StandardMaterialAdjustmentsPanel extends Panel {
    constructor(mesh) {
        super();
            ...
            },
            {
                ...
                callback: (value, item) => {
                    ...
                    if (mesh.userData.adjustments) {
                        materials.forEach(material => material.userData.onBeforeCompile.adjustments = MaterialPatches.Standard.adjustments);
